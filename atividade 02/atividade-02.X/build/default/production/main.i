...
void main(void) {
    ...
    while (1) {
        ...
        count = (ADRESH * 0x100) + ADRESL;
        tensao = ((5 * count) / 1023.0);
        if (tensao == 0) {
            print_belt(1);
        } else {
            print_belt(0);
            if (tensao <= 1) {
                ...
                _delay((unsigned long)((252)*(4000000/4000.0)));
            } else if (tensao <= 4) {
                _delay((unsigned long)((126)*(4000000/4000.0)));
            } else if (tensao <= 5) {
                _delay((unsigned long)((63)*(4000000/4000.0)));
            }
        }
    }
}
